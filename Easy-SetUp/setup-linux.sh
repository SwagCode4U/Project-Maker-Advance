...
# ProjectMaker Easy Setup Script for Linux
# This script automates the entire setup process for Linux users
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  ProjectMaker - Easy Setup (Linux)    ${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
echo -e "  Run: ./Easy-SetUp/stop-linux.sh"
